...
enum class Country(private val responseId: Int): BaseEnum {
    COUNTRIES(R.string.ALL_COUNTRIES), US(R.string.US), CA(R.string.CA), BR(R.string.BR), AE(R.string.AE), AR(R.string.AR),
